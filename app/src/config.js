 ...
 layers: [
  {
    ...
    scale: "national",
    sourceType: "vector",
    tilesetUrl: "mapbox://lickergeospatial.lgeo-national-points",
    sourceLayer: "NationalLevelPoints",
    color: "#e78f4c",
    minzoom: 0,
    maxzoom: 3.7,
    defaultVisible: true
  },
  {
    ...
    scale: "provincial",
    sourceType: "vector",
    tilesetUrl: "mapbox://lickergeospatial.lgeo-provincial-points",
    sourceLayer: "ProvincialLevelPoints",
    color: "#e78f4c",
    minzoom: 3.7,
    maxzoom: 5.4,
    defaultVisible: true
  },
  {
    ...
    scale: "regional",
    sourceType: "vector",
    tilesetUrl: "mapbox://lickergeospatial.lgeo-regional-points",
    sourceLayer: "RegionalLevelPoints",
    color: "#e78f4c",
    minzoom: 5.4,
    maxzoom: 7.8,
    defaultVisible: true
  },
  {
    ...
    scale: "municipal",
    sourceType: "vector",
    tilesetUrl: "mapbox://lickergeospatial.lgeo-municipal-points",
    sourceLayer: "MunicipalLevelPoints",
    color: "#e78f4c",
    minzoom: 7.8,
    maxzoom: 24,
    defaultVisible: true
  },
  {
    ...
    scale: "provincial",
    sourceType: "vector",
    tilesetUrl: "mapbox://lickergeospatial.lgeo-provincial-polygons",
    sourceLayer: "ProvincialLevelPolygons",
    color: "#89b8b7",
    minzoom: 3.7,
    maxzoom: 5.4,
    defaultVisible: true
  },
  {
    ...
    scale: "regional",
    sourceType: "vector",
    tilesetUrl: "mapbox://lickergeospatial.lgeo-regional-polygons",
    sourceLayer: "RegionalLevelPolygons",
    color: "#86b4b3",
    minzoom: 5.4,
    maxzoom: 7.8,
    defaultVisible: true
  },
  {
    ...
    scale: "municipal",
    sourceType: "vector",
    tilesetUrl: "mapbox://lickergeospatial.lgeo-municipal-polygons",
